...
from BCRNN.policy.base_image_policy import BaseImagePolicy


class BCRNNRunner:
    def __init__(self, n_obs_steps=3):
    ...
    def get_action(self, policy: BaseImagePolicy, observaton=None):
        ...
        with torch.no_grad():
            obs_dict_input = {} 
            obs_dict_input['img'] = obs_dict['img'].unsqueeze(0)
            obs_dict_input['joint_state'] = obs_dict['joint_state'].unsqueeze(0)
        ...
        # print("action_pred", np_action_dict['action_pred'].squeeze(0))
        return action

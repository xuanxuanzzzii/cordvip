...
from diffusion_policy.model.vision_3d.positional_encoding import PositionalEncoding
from diffusion_policy.model.vision_3d.pointnet2_encoder import PointNet2EncoderXYZ
from diffusion_policy.model.vision_3d.pointnext_encoder import PointNextEncoderXYZ
try:
    from diffusion_policy.model.vision_3d.voxelcnn_encoder import VoxelCNN
except:
    print("voxel cnn not found. pass")
from diffusion_policy.model.vision_3d.pointtransformer_encoder import Backbone as PT_Backbone
...
class PointNetImaginationExtractor(nn.Module):
    def __init__(self, 
        ...
        if self.use_rgb_image:
            ...
            from co_diffusion_policy.common.robomimic_config_util import get_robomimic_config
            import co_diffusion_policy.model.vision.crop_randomizer as dmvc
            from co_diffusion_policy.common.pytorch_util import dict_apply, replace_submodules
        ...
        # not used
        from co_diffusion_policy.model.vision_3d.pointnet import PointNet, PointNetMedium, PointNetLarge
